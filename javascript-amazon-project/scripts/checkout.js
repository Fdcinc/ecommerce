...
// We wrap everything in a function so we can refresh the UI easily
export function renderOrderSummary() {
  ...
  cart.forEach((cartItem) => {
    ...
    // Find the delivery option saved in the cart for this product
  ...
  // --- EVENT LISTENERS (Moved inside the function) ---
  ...
  document.querySelectorAll('.js-delete-link').forEach((link) => {
    link.addEventListener('click', () => {
      ...
      renderOrderSummary(); // Refresh the UI
    });
  });
